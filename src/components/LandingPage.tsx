...
const LandingPage: React.FC<Props> = ({ onStart, session, onOpenAuth, profile, onSignOut, onUpgrade, showPaymentSuccess }) => {
  ...
  return (
    <div className="min-h-screen bg-[#030407] text-slate-200 overflow-x-hidden selection:bg-violet-500/30">
      ...
      {/* Powered By Data Sources Section - Animated Scrolling Marquee */}
      <section className="pb-16 overflow-hidden">
        <div className="text-center mb-8">
          <div className="text-[10px] font-black text-violet-400 uppercase tracking-[0.3em]">
        ...
        <div className="relative">
          {/* Gradient fade edges */}
          <div className="absolute left-0 top-0 bottom-0 w-32 bg-gradient-to-r from-[#030407] to-transparent z-10 pointer-events-none"></div>
          <div className="absolute right-0 top-0 bottom-0 w-32 bg-gradient-to-l from-[#030407] to-transparent z-10 pointer-events-none"></div>

          {/* Scrolling container */}
          <div className="flex animate-scroll-infinite hover:pause-animation">
            {/* First set of logos */}
            <div className="flex items-center gap-12 md:gap-20 px-8 flex-shrink-0">
              {/* Twitter/X */}
              <div className="flex flex-col items-center opacity-60 hover:opacity-100 transition-opacity duration-300">
                <svg className="w-10 h-10 md:w-12 md:h-12 text-slate-400 hover:text-blue-400 transition-colors" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                </svg>
                <div className="text-[7px] md:text-[8px] font-bold text-slate-500 mt-2 uppercase tracking-wider whitespace-nowrap">Twitter/X</div>
              </div>

              {/* Reddit */}
              <div className="flex flex-col items-center opacity-60 hover:opacity-100 transition-opacity duration-300">
                <svg className="w-10 h-10 md:w-12 md:h-12 text-slate-400 hover:text-orange-400 transition-colors" viewBox="0 0 24 24" fill="currentColor">
                ...
                <div className="text-[7px] md:text-[8px] font-bold text-slate-500 mt-2 uppercase tracking-wider whitespace-nowrap">Reddit</div>
              </div>

              {/* HackerNews */}
              <div className="flex flex-col items-center opacity-60 hover:opacity-100 transition-opacity duration-300">
                <div className="w-10 h-10 md:w-12 md:h-12 bg-[#ff6600] rounded-sm flex items-center justify-center hover:bg-[#ff8833] transition-colors">
                  <span className="text-white font-black text-xl md:text-2xl">Y</span>
                </div>
                <div className="text-[7px] md:text-[8px] font-bold text-slate-500 mt-2 uppercase tracking-wider whitespace-nowrap">HackerNews</div>
              </div>

              {/* GitHub */}
              <div className="flex flex-col items-center opacity-60 hover:opacity-100 transition-opacity duration-300">
                <svg className="w-10 h-10 md:w-12 md:h-12 text-slate-400 hover:text-white transition-colors" viewBox="0 0 24 24" fill="currentColor">
                ...
                <div className="text-[7px] md:text-[8px] font-bold text-slate-500 mt-2 uppercase tracking-wider whitespace-nowrap">GitHub</div>
              </div>

              {/* Gemini AI */}
              <div className="flex flex-col items-center opacity-60 hover:opacity-100 transition-opacity duration-300">
                <div className="w-10 h-10 md:w-12 md:h-12 bg-gradient-to-br from-blue-500 via-violet-500 to-purple-500 rounded-xl flex items-center justify-center hover:scale-110 transition-transform">
                  <span className="text-white font-black text-base md:text-lg">✦</span>
                </div>
                <div className="text-[7px] md:text-[8px] font-bold text-slate-500 mt-2 uppercase tracking-wider whitespace-nowrap">Gemini AI</div>
              </div>
            </div>
            ...
            {[
              ...
              >
                ...
                >
                  ...
                  <ChevronDown
                    className={`w-5 h-5 text-violet-400 flex-shrink-0 transition-transform duration-300 ${openFaqIndex === index ? 'rotate-180' : ''
                      }`}
                  />
                </button>
                <div
