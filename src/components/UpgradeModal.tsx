      ...
      <div className="glass-panel relative w-full max-w-4xl rounded-[2.5rem] border border-white/10 shadow-2xl animate-in zoom-in-95 duration-300 overflow-hidden">
        ...
        <div className="p-10 relative z-10">
          ...
          <div className="text-center mb-12 space-y-3">
            <h2 className="text-4xl font-bold text-white tracking-tight">Upgrade your <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-400">Intelligence</span></h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            {/* Pro Plan */}
            <div className="glass-card rounded-3xl p-1 relative border border-blue-500/30">
              <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-4 py-1 rounded-full text-xs font-bold shadow-lg shadow-blue-500/30 flex items-center space-x-1">
