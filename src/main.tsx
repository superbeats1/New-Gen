...
console.log('%c ✨ SCOPA AI v2.23.0 - UX ENHANCEMENTS! ✨ ', 'background: #8b5cf6; color: #fff; padding: 10px; border-radius: 8px; font-weight: 900; font-size: 14px; border: 2px solid #fff;');
(window as any).SCOPA_VERSION = '2.23.0';
