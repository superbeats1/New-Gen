...
console.log('%c 🎯 SCOPA AI v2.15.1 - DIRECT TO INTELLIGENCE HUB! 🎯 ', 'background: #3b82f6; color: #fff; padding: 10px; border-radius: 8px; font-weight: 900; font-size: 14px; border: 2px solid #fff;');
(window as any).SCOPA_VERSION = '2.15.1';
