...
console.log('%c 🎯 SCOPA AI v2.12.0 - COMPETITOR WEAKNESS MAP ACTIVE! 🎯 ', 'background: #f43f5e; color: #fff; padding: 10px; border-radius: 8px; font-weight: 900; font-size: 14px; border: 2px solid #fff;');
(window as any).SCOPA_VERSION = '2.12.0';
