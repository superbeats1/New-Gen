...
console.log('%c 🎯 SCOPA AI v2.18.1 - FLASH MODEL! 🎯 ', 'background: #eab308; color: #000; padding: 10px; border-radius: 8px; font-weight: 900; font-size: 14px; border: 2px solid #000;');
(window as any).SCOPA_VERSION = '2.18.1';
