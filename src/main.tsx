...
console.log('%c 🚨 SCOPA AI CORE v2.6.5 - GEMINI-PRO STABLE 🚨 ', 'background: #8b5cf6; color: #fff; padding: 10px; border-radius: 8px; font-weight: 900; font-size: 14px; border: 2px solid #fff;');
(window as any).SCOPA_VERSION = '2.6.5';
