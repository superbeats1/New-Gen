...
console.log('%c 🔧 SCOPA AI v2.21.5 - NAVIGATION FIXED! 🔧 ', 'background: #f59e0b; color: #fff; padding: 10px; border-radius: 8px; font-weight: 900; font-size: 14px; border: 2px solid #fff;');
(window as any).SCOPA_VERSION = '2.21.5';
